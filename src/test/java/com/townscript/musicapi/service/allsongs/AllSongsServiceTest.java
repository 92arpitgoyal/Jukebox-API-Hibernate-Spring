...
import com.townscript.musicapi.model.AllSongsRowMapper;
import com.townscript.musicapi.model.Users;
import com.townscript.musicapi.model.UsersRowMapper;

public class AllSongsServiceTest {
	
	private AllSongsService allSongsService = new AllSongsServiceImpl();
	...
	public void testAddSong(){
		String title = "in the end", artist = "linkin park", path = "/var/www/music/lp/intheend.mp3";
		int songId = allSongsService.addSong(title, artist, path);
		...
		List<AllSongs> songList = jdbcTemplateForAccess.query(sqlForAccess, new AllSongsRowMapper());
	...
	public void testMoveToPlaylist(){
		...
		allSongsService.moveToPlaylist(songId, userId);
	...
	public void testDownVote(){
		...
		allSongsService.downVote(songId);
