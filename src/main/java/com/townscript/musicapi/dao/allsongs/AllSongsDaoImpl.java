...
public class AllSongsDaoImpl implements AllSongsDao {
	...
	public int addToAllSongs(String title, String artist, String path) {
		final String sql = "INSERT INTO ALL_SONGS (SONG_ID, SONG_TITLE, SONG_ARTIST, THUMBS_UP_COUNT, THUMBS_DOWN_COUNT, SONG_PATH, IN_PLAYLIST) VALUES (0, '"+ title +"', '"+ artist +"', 0, 0, '"+ path +"', false)";
		JdbcTemplate jdbcTemplate = JdbcTemplateFactory.getJdbcTemplate();
